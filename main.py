...
gpx_data_path = "input/new.gpx"  # Update path to include input directory
...
valhalla_instructions = map_matching_api_valhalla.get_valhalla_instructions(
    valhalla_base_url, coordinates
)
print("\nRoute info from valhalla\n")
pprint(valhalla_instructions)


walk_simulator.get_video_instructions_from_coordinates(
    coordinates, valhalla_instructions
)
